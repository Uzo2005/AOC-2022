...
# proc popNumberOfTimes [T](seqOfStuffs: var seq[seq[T]], numberOfTimes: int): seq[seq[T]] =
#     var poppedStuffs: seq[seq[T]]
#     for num in 1..numberOfTimes:
#         var poppedOut = seqOfStuffs.pop()
#         poppedStuffs.add(poppedOut)

#     poppedStuffs.reverse() #this is to account for cratemover 9001
#     result = poppedStuffs
    


# proc pushPoppedStuffs [T](seqOfStuffs: var seq[seq[T]], poppedStuffs: var seq[seq[T]]): seq[seq[T]] =
#     for stuff in poppedStuffs:
#         seqOfStuffs.add(stuff)
...
for index, instructionSet in instructionSeq:
    ...
    var tempContainer: seq[seq[char]]
    ...
    for stuff in tempContainer:
        endSetOfCrates.add(stuff)
